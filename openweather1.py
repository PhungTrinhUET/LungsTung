...
ACCESS_TOKEN = "CjGp4vLofCTZcx06bmhD"  # Mã thông báo để xác thực thiết bị trên ThingsBoard
...
def send_data(client):
    ...
    if temperature is not None and humidity is not None:
        ...
        sensor_data = {
            ...
            "outsideMaxTemp": 0,  # Giá trị maxTemp không có từ OpenWeatherMap, bạn có thể điền giá trị tương ứng nếu cần
            "outsideMinTemp": 0,  # Giá trị minTemp không có từ OpenWeatherMap, bạn có thể điền giá trị tương ứng nếu cần
            "dateTime": "1970-01-01 00:00:00",  # Bạn cần cập nhật giá trị thời gian tương ứng từ OpenWeatherMap
        }
